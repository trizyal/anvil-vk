...
namespace AnvilShaders
{
    ...
    {
        /** 32-bit SPIR-V binary words generated by the compiler. */
        std::vector<uint32_t> spirv;

        /** Slang reflection interface containing bindings and push constant data. */
        Slang::ComPtr<slang::IComponentType> reflection;

        /** Contains Slang warnings and error logs if compilation failed or produced warnings. */
