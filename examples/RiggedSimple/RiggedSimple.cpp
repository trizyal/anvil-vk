...
void RiggedSimple::initializeProject(VulkanContext& inContext, Swapchain& inSwapchain)
{
    ...
    const char* modelPath = PROJECT_DIR "/RiggedSimple/glTF/RiggedSimple.gltf";
...
void RiggedSimple::cleanupProject()
{
    if (pContext)
    {
...
void RiggedSimple::loadPipeline()
{
    ...
    const auto attributesArray = GPUMesh::getAttributeDescriptions();
